...
import { Constraints, webPublishOption, ZegoResponse } from "../../../common/zego.entity";
import { StreamHandler } from "../../../common/streamHandler";
...
export declare class PublishModule {
    ...
    private rtm;
    constructor(logger: ZegoLogger, dataReport: ZegoDataReport, stateCenter: StateCenter, streamCenter: ZegoStreamCenterWeb, streamHandler: StreamHandler, rtm: ZegoExpressWebRTM);
